...
@pytest.mark.parametrize(
    "user_bouquet, menu1, key, dict_user_bouquet",
    [
...
@pytest.mark.parametrize(
    "key, dict_user_bouquet, menu1, not_in_menu, stock_bouquet, overflow_menu",
    [
